...
def index_test_yourself(request):
    ...
    #Biology filters
    Bio_9700_2022_March_multiple_choice_available_list = FullQuestionAnswer.objects.filter(paper_number__paper_num='1',subject_key__subject='Biology ~ 9700',year_key__year='2022',session_key__session='March')
    Bio_9700_2022_June_multiple_choice_available_list = FullQuestionAnswer.objects.filter(paper_number__paper_num='1',subject_key__subject='Biology ~ 9700',year_key__year='2022',session_key__session='June')
    Bio_9700_2022_November_multiple_choice_available_list = FullQuestionAnswer.objects.filter(paper_number__paper_num='1',subject_key__subject='Biology ~ 9700',year_key__year='2022',session_key__session='November')
    Bio_9700_2021_March_multiple_choice_available_list = FullQuestionAnswer.objects.filter(paper_number__paper_num='1',subject_key__subject='Biology ~ 9700',year_key__year='2021',session_key__session='March')
    Bio_9700_2021_June_multiple_choice_available_list = FullQuestionAnswer.objects.filter(paper_number__paper_num='1',subject_key__subject='Biology ~ 9700',year_key__year='2021',session_key__session='June')
    Bio_9700_2021_November_multiple_choice_available_list = FullQuestionAnswer.objects.filter(paper_number__paper_num='1',subject_key__subject='Biology ~ 9700',year_key__year='2021',session_key__session='November')
